...
function App({ Component, pageProps }: AppProps): JSX.Element {
    ...
    useEffect((): (() => void) => {
        ...
        const cursor: HTMLElement | null = document.getElementById("cursor-outer");
        const cursorinner: HTMLElement | null = document.getElementById("cursor-inner");
        ...
        NProgress.configure({
            template: "<div class='bar' role='bar' style='height: 0.3rem; background: var(--primary-color);'></div>"
        });

        const handleStart: (url: string) => NProgress.NProgress = (): NProgress.NProgress => NProgress.start();
